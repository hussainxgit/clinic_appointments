...
class _AppointmentsScreenState extends State<AppointmentsScreen>
  ...
  Widget _buildAppointmentList(String status) {
    return Consumer<AppointmentProvider>(
      builder: (context, provider, child) {
        ...
        final filteredAppointments = provider.appointments.where((item) {
  ...
  Widget _buildAppointmentItem(
    ...
    final statusColor = appointment.status == 'scheduled'
        ? Colors.blue
    ...
    final dateTime =
        DateFormat('E, MMM d, yyyy • h:mm a').format(appointment.dateTime);
    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () {
          ServiceLocator.get<NavigationService>().navigateTo(
            '/appointment/details',
            arguments: {
  ...
  Future<void> _completeAppointment(Appointment appointment) async {
    ...
    if (confirmed == true) {
      ...
      final result = await provider.completeAppointment(
        appointment.id,
        paymentStatus:
  ...
  Future<void> _cancelAppointment(Appointment appointment) async {
    ...
    if (confirmed == true) {
      final provider = Provider.of<AppointmentProvider>(context, listen: false);
      final result = await provider.cancelAppointment(appointment.id);
